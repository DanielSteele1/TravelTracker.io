...
const LayerMenu = ({onLayerChange}) => {
    ...
    return (
        ...
        <div className="map-layer-menu">
            ...
            <button className="map-layer-item"  onClick={() => onLayerChange('Traffic')}> <LocalShippingIcon  sx={{ padding: '5px' }}></LocalShippingIcon><h4> Traffic </h4> </button>
            ...
            <button className="map-layer-item"  onClick={() => onLayerChange('Roads')}> <CommuteIcon  sx={{ padding: '5px' }}></CommuteIcon> <h4> Roads </h4></button>
